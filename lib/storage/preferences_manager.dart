...
class PreferencesManager {
  ...
  static Map<String, dynamic> createProjectEntry(String projectId, String projectName) {
    return {
      'id': projectId,
      'name': projectName,
  ...
  static Future<bool> addRecentProject(String projectId, String projectName) async {
    final prefs = await SharedPreferences.getInstance();
    ...
    final existingIndex = recentProjects.indexWhere((p) => p['id'] == projectId);
    if (existingIndex >= 0) {
